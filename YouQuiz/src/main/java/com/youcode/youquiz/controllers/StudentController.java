...
public class StudentController {
    ...
    @GetMapping
    public ResponseEntity<List<StudentDto>> getStudents(@RequestParam(defaultValue = "0") int page, @RequestParam(defaultValue = "10") int size) {
        List<StudentDto> students = studentService.getAll(page, size);
